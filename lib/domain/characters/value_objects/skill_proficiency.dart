/// ---------------------------------------------------------------------------
/// Fichier : lib/domain/characters/value_objects/skill_proficiency.dart
/// Rôle : Suivre une compétence maîtrisée et son origine.
...
/// SkillProficiency = Value Object décrivant une maîtrise de compétence.
///
/// * Pré-condition : `code` non vide.
/// * Post-condition : immuable avec indicateur d'expertise.
/// * Erreurs : `ArgumentError` si code vide ou sources incohérentes.
