/// ---------------------------------------------------------------------------
/// Fichier : lib/domain/characters/value_objects/superiority_dice.dart
/// Rôle : Porter la taille et le nombre de dés de supériorité.
...
///
/// * Pré-condition : `count` >= 0 et `die` parmi {4,6,8,10,12} quand count > 0.
